 ...
 * @throws IllegalDimension If the supplied components are not those of a square matrix.
 * @throws NonSymmetricComponents If the supplied components are not symmetric.
 */
 ...
 * @param a MatrixAlgebra.Matrix
 * @throws IllegalDimension If the number of columns of the receiver are not equal to the number of columns of the supplied matrix.
 */
 ...
 * @param a MatrixAlgebra.SymmetricMatrix
 * @throws IllegalDimension If the number of rows of the receiver are not equal to the number of rows of the supplied matrix.
 */
