 ...
 *
 * @version $Id: Variate.java 43609 2011-07-28 03:19:13Z matthew $
 *
...
public interface Variate
{
	...
	public class Double implements Variate {
		 ...
		 * @return if the value for index is missing
		 */
		public boolean isMissing(int index) { return (java.lang.Double.isNaN(values[index])); }
	...
	public class Float implements Variate {
		 ...
		 * @return if the value for index is missing
		 */
		public boolean isMissing(int index) { return (java.lang.Float.isNaN(values[index])); }
