 ...
 *
 * @version $Id: DiscreteStatistics.java 43609 2011-07-28 03:19:13Z matthew $
 *
...
public class DiscreteStatistics {
    ...
    public static double median(double[] x) {
        ...
        if(x.length == 0)
            throw new IllegalArgumentException("You may not call this method with a 0 length array");
