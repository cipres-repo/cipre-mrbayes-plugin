-- ======================================================================================================
--   GENEIOUS Shared Database SCHEMA 4.8.0 TO 5.3.999 UPGRADE SCRIPT (Oracle)
--
...
ALTER TABLE document_file_data ADD local_file_path CLOB;
ALTER TABLE document_file_data ADD local_file_size INTEGER;
ALTER TABLE document_file_data ADD last_needed TIMESTAMP;
