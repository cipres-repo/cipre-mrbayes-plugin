...
Description:  Compresses sequence data into a fasta file holding all kmers.

Usage:
Generation:   kcompress.sh in=<reads> out=<contigs> mincount=<1>
...
contigpasses=5      Build contigs with decreasing seed depth for this many iterations.
contigpassmult=4    Ratio between seed depth of two iterations.
