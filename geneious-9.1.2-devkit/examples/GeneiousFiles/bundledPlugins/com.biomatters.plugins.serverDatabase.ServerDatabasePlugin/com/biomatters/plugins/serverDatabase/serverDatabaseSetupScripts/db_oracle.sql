...
-- GRANT SELECT ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE TO user;
-- =====================================
...
--   ORACLE NOTES
--
--   This script has been tested on Oracle Express 10g
-- =========================================================================
...
CREATE TABLE special_element (
   ...
   modified                TIMESTAMP      NOT NULL,
   xml                     CLOB           NOT NULL,   -- Any arbitrary xml
...
CREATE TABLE annotated_document (
   ...
   document_xml            CLOB           NOT NULL,   -- The annotated document
   plugin_document_xml     CLOB           NOT NULL,   -- Underlying plugin document
...
CREATE TABLE document_file_data (
    ...
    data BLOB,
    local_file_path CLOB,
    local_file_size NUMBER(20),
...
-- Don't need an index for document_id because it is the primary key and already indexed
